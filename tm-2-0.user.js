...
Будем делать заново в следующем сезоне(`, 'danger', 10000)
    ...
    if (currentWindow.checkPath(pagePatterns.index)) {
        document.querySelector('.main-page').childNodes[1].innerHTML += '<br>Установлены скрипты Tampermonkey 2.0 (v.0.2.0.3 от 21 апреля 2025)<br>Примеры скриптов можно посмотреть <a href="https://github.com/maxina29/tm-2-adminka/tree/main/scripts_examples" target="_blank">здесь</a>'
