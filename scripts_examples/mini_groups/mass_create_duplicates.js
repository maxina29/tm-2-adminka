...
for (let id of ids) {
    ...
    tempWindow.document.querySelector('#course_duplicate_group_templates_attributes_0_week_days_attributes_0_slot_time').value = '10:00'
    ...
    tempWindow.document.querySelector('#course_duplicate_copy_preparation_materials').checked = true;
